...
export function TimeFormatToggle({
	...
	const toggleFormat = () => {
		setIsAnimating(true)
		const newFormat =
			format === TimeFormatType.HOUR_24 ? TimeFormatType.HOUR_12 : TimeFormatType.HOUR_24
		onChange(newFormat)
	...
	const getAnimationDirection = () => {
		if (format === TimeFormatType.HOUR_12 && previousFormat === TimeFormatType.HOUR_24) {
			return 1
		} else if (format === TimeFormatType.HOUR_24 && previousFormat === TimeFormatType.HOUR_12) {
			return -1
		}
		return 0
	}
