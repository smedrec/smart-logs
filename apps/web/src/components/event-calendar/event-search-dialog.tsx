...
import type { SearchEventFilter } from '@/lib/validations'
				...
				<div className="flex-1 space-y-4 overflow-hidden">
					...
					{searchQuery.trim().length >= 2 && !isLoading && (
						<div className="text-muted-foreground text-sm">
							{totalCount > 0 ? (
								<>
									Found {totalCount} event{totalCount !== 1 ? 's' : ''} matching &quot;{searchQuery}
									&quot;
						...
						<ScrollArea className="h-[400px] flex-1">
							{error ? (
								...
								<div className="flex items-center justify-center py-8">
									...
									<span className="text-muted-foreground ml-2 text-sm">Searching events...</span>
								</div>
