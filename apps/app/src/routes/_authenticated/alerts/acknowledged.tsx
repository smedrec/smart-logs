...
export const Route = createFileRoute('/_authenticated/alerts/acknowledged')({
...
function RouteComponent() {
	...
	const { data: acknowledgedAlerts } = useLiveQuery((q) =>
		q.from({ alert: alertsCollection }).where(({ alert }) => eq(alert.acknowledged, 'true'))
	)
	return <ComingSoon />
}
